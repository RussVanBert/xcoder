  ...
  describe "Boolean Properties" do
    ...
    it "should be able to set to false with NO" do
      ...
      boolean_properties.each do |property|
        ...
        expect(subject.send(property)).to be_falsey, "#{property} failed to be set correctly to false"
      end
    ...
    it "should be able to true with YES" do
      ...
      boolean_properties.each do |property|
        ...
        expect(subject.send(property)).to be_truthy, "#{property} failed to be set correctly to true"
      end
